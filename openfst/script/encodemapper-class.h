...
#ifndef OPENFST_SCRIPT_ENCODEMAPPER_CLASS_H_
#define OPENFST_SCRIPT_ENCODEMAPPER_CLASS_H_
...
class EncodeMapperClass {
 public:
  ...
  EncodeMapperClass(absl::string_view arc_type, uint8_t flags,
  ...
  static absl_nullable std::unique_ptr<EncodeMapperClass> Read(
...
struct EncodeMapperClassIORegistration {
  using Reader = std::unique_ptr<EncodeMapperClass> (*)(
      std::istream &stream, absl::string_view source);
...
#endif  // OPENFST_SCRIPT_ENCODEMAPPER_CLASS_H_
