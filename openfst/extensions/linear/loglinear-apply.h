...
#ifndef OPENFST_EXTENSIONS_LINEAR_LOGLINEAR_APPLY_H_
#define OPENFST_EXTENSIONS_LINEAR_LOGLINEAR_APPLY_H_
...
#endif  // OPENFST_EXTENSIONS_LINEAR_LOGLINEAR_APPLY_H_
