...
#ifndef OPENFST_EXTENSIONS_COMPRESS_COMPRESSSCRIPT_H_
#define OPENFST_EXTENSIONS_COMPRESS_COMPRESSSCRIPT_H_
...
#endif  // OPENFST_EXTENSIONS_COMPRESS_COMPRESSSCRIPT_H_
