...
ABSL_FLAG(std::string, arc_filter, "any",
          "Arc filter: one of"
...
ABSL_FLAG(std::string, info_type, "auto",
          ...
          " but less than \"long\".");
ABSL_FLAG(bool, test_properties, true,
          "Compute property values (if unknown to FST)");
ABSL_FLAG(bool, fst_verify, true, "Verify FST sanity");
