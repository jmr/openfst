...
#ifndef OPENFST_LIB_MAPPED_FILE_H_
#define OPENFST_LIB_MAPPED_FILE_H_
...
class MappedFile {
 public:
  ...
  // input stream.
  static MappedFile *absl_nullable Map(std::istream &istrm, bool memorymap,
  ...
  static MappedFile *absl_nullable MapFromFileDescriptor(int fd, size_t pos,
                                                         size_t size);
...
#endif  // OPENFST_LIB_MAPPED_FILE_H_
