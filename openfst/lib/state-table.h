...
#ifndef OPENFST_LIB_STATE_TABLE_H_
#define OPENFST_LIB_STATE_TABLE_H_
...
class DefaultComposeStateTuple {
 public:
  ...
  size_t Hash() const {
    return absl::HashOf(StateId1(), StateId2(), GetFilterState().Hash());
  }
...
class DefaultComposeStateTuple<S, TrivialFilterState> {
 public:
  ...
  size_t Hash() const { return absl::HashOf(StateId1(), StateId2()); }
...
#endif  // OPENFST_LIB_STATE_TABLE_H_
