...
#ifndef OPENFST_LIB_PROPERTIES_H_
#define OPENFST_LIB_PROPERTIES_H_
...
ABSL_CONST_INIT extern const absl::string_view PropertyNames[];
...
#endif  // OPENFST_LIB_PROPERTIES_H_
