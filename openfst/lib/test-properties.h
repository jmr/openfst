...
#ifndef OPENFST_LIB_TEST_PROPERTIES_H_
#define OPENFST_LIB_TEST_PROPERTIES_H_
...
ABSL_DECLARE_FLAG(bool, fst_verify_properties);
...
uint64_t TestProperties(const Fst<Arc> &fst, uint64_t mask, uint64_t *known) {
  if (absl::GetFlag(FLAGS_fst_verify_properties)) {
...
#endif  // OPENFST_LIB_TEST_PROPERTIES_H_
