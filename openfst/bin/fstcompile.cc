...
ABSL_FLAG(std::string, fst_type, "vector", "Output FST type");
...
ABSL_FLAG(bool, keep_isymbols, false,
          "Store input label symbol table with FST");
ABSL_FLAG(bool, keep_osymbols, false,
          "Store output label symbol table with FST");
ABSL_FLAG(bool, keep_state_numbering, false, "Do not renumber input states");
